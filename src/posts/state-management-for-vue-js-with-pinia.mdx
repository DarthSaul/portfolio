...
date: 2023-01-19
description: A walkthrough of building your first Pinia store.
tags:
  - vue
  - pinia
  - state-management
...
_Originally published on [Medium](https://medium.com/@saulgraves/state-management-for-vue-js-with-pinia-af9a1533cf20) in January 2023._
...
Keep in mind that you should _not_ by default install and utilize a state management solution, regardless of the specifics of your application. If you’re building a simple calculator app, for example, you most likely do not need global state.
...
- [Pinia documentation](https://pinia.vuejs.org/) — there’s **_a lot_** more to Pinia than what we covered today!
