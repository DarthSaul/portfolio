			...
			<div className="hero-body">
				...
				<div className="hero-text">
					<div className="hero-headline">
						<span className="hero-title">Senior Fullstack Engineer</span>
						<span className="hero-subtitle">
							I'm a builder, system designer, and a thoughtful pair of eyes in
							an era of AI-generated everything. I care about product craft,
							building stable & performant platforms, and making complex
							systems feel simple.
						</span>

						<span className="hero-extra">
							<span>&&</span>reading fantasy, cooking, brewing coffee, talking
							hoop, and watching Princess Mononoke again.
						</span>
					</div>
				</div>
			</div>
